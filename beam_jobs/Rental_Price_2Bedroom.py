...
def run(argv=None):	
	...
	with beam.Pipeline(options=pipeline_options) as p:
		...
		table_name = "spooky-data-seance:zillow.Rental_Price_2Bedroom" # format: project_id:dataset.table
		table_schema = init_bigquery_table()
    
		lines = p | 'ReadFile' >> beam.io.ReadFromText('gs://bayes-the-databae/zillow/Zip_MedianRentalPrice_2Bedroom.csv')
